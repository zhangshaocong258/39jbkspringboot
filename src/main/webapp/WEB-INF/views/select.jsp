        ...
        <form name="myform" class="form-horizontal" action="result" method="get" onsubmit="return submitTest()">
            ...
            <div style="position:absolute;left:92px;top:220px;width:655px;">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation"><a href="#maixiang" aria-controls="maixiang" role="tab"
                                               data-toggle="tab">脉象</a>
                    </li>
                </ul>
                ...
                <div style="overflow:auto;height:400px;" class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="zhengzhuang">
                        ...
                        <ul class="nav nav-pills" role="tablist">
                            <li role="presentation" class="active"><a href="#toubu" aria-controls="toubu" role="tab"
                                                                      data-toggle="tab">头部</a></li>
                            <li role="presentation"><a href="#xiongbu" aria-controls="xiongbu" role="tab"
                                                       data-toggle="tab">胸部</a>
                            </li>
                            <li role="presentation"><a href="#yaofubu" aria-controls="yaofubu" role="tab"
                                                       data-toggle="tab">腰腹部</a>
                            </li>
                            <li role="presentation"><a href="#zhiti" aria-controls="zhiti" role="tab" data-toggle="tab">肢体</a>
                            </li>
                            <li role="presentation"><a href="#shengzhi" aria-controls="shengzhi" role="tab"
                                                       data-toggle="tab">生殖</a>
                            </li>
                            <li role="presentation"><a href="#quanshen" aria-controls="qita" role="tab"
                                                       data-toggle="tab">全身</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="toubu">

                                <table class="table table-striped">
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="面色淡白">&thinsp;&thinsp;面色淡白
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="两目干涩">&thinsp;&thinsp;两目干涩
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="面色潮红">&thinsp;&thinsp;面色潮红
                                        </td>
                                    </tr>

                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="面色萎黄">&thinsp;&thinsp;面色萎黄
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="唇苍白">&thinsp;&thinsp;唇苍白
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="口燥咽干">&thinsp;&thinsp;口燥咽干
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="头面浮肿">&thinsp;&thinsp;头面浮肿
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="目不欲睁">&thinsp;&thinsp;目不欲睁
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div role="tabpanel" class="tab-pane" id="xiongbu">
                                <table class="table table-striped">
                            ...
                            <div role="tabpanel" class="tab-pane" id="yaofubu">
                                <table class="table table-striped">
                            ...
                            <div role="tabpanel" class="tab-pane" id="zhiti">
                                <table class="table table-striped">
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="腿酸">&thinsp;&thinsp;腿酸</td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="膝软无力">&thinsp;&thinsp;膝软无力
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="双下肢水肿">&thinsp;&thinsp;双下肢水肿
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="不能久立">&thinsp;&thinsp;不能久立
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="步履不正">&thinsp;&thinsp;步履不正
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="甲苍白">&thinsp;&thinsp;甲苍白
                                        </td>
                                    </tr>
                            ...
                            <div role="tabpanel" class="tab-pane" id="shengzhi">
                                <table class="table table-striped">
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="白带多">&thinsp;&thinsp;白带多
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="月经少">&thinsp;&thinsp;月经少
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="月经过多">&thinsp;&thinsp;月经过多
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="尿混浊">&thinsp;&thinsp;尿混浊
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="大便干结">&thinsp;&thinsp;大便干结
                                        </td>
                                    </tr>

                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="大便时溏">&thinsp;&thinsp;大便时溏
                                        </td>
                                    </tr>

                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="月经失调">&thinsp;&thinsp;月经失调
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="大便失禁">&thinsp;&thinsp;大便失禁
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="尿无力">&thinsp;&thinsp;尿无力
                                        </td>
                                    </tr>
                            ...
                            <div role="tabpanel" class="tab-pane" id="quanshen">
                                <table class="table table-striped">

                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="精神不振">&thinsp;&thinsp;精神不振
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="神思恍惚">&thinsp;&thinsp;神思恍惚
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="善惊易恐">&thinsp;&thinsp;善惊易恐
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="失眠多梦">&thinsp;&thinsp;失眠多梦
                                        </td>
                                    </tr>

                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="急躁易怒">&thinsp;&thinsp;急躁易怒
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="五心烦热">&thinsp;&thinsp;五心烦热
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="形体消瘦">&thinsp;&thinsp;形体消瘦
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="关节屈伸不利">&thinsp;&thinsp;关节屈伸不利
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="肢体麻木">&thinsp;&thinsp;肢体麻木
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="肢体拘挛">&thinsp;&thinsp;肢体拘挛
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="肢体强直">&thinsp;&thinsp;肢体强直
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="肢体抽搐">&thinsp;&thinsp;肢体抽搐
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="口淡无味">&thinsp;&thinsp;口淡无味
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="食欲不振">&thinsp;&thinsp;食欲不振
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="肢体酸楚">&thinsp;&thinsp;肢体酸楚
                                        </td>
                                    </tr>

                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="肢倦乏力">&thinsp;&thinsp;肢倦乏力
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="怠惰嗜卧">&thinsp;&thinsp;怠惰嗜卧
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="忧虑重重">&thinsp;&thinsp;忧虑重重
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="少气懒言">&thinsp;&thinsp;少气懒言
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="畏寒肢冷">&thinsp;&thinsp;畏寒肢冷
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="不能食生冷">&thinsp;&thinsp;不能食生冷
                                        </td>
                                    </tr>

                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="肢体浮肿">&thinsp;&thinsp;肢体浮肿
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="皮肤苍白">&thinsp;&thinsp;皮肤苍白
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="四肢疼痛">&thinsp;&thinsp;四肢疼痛
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="关节酸楚">&thinsp;&thinsp;关节酸楚
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="完谷不化">&thinsp;&thinsp;完谷不化
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="周身瘙痒">&thinsp;&thinsp;周身瘙痒
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="zhengzhuang" value="矢气频频">&thinsp;&thinsp;矢气频频
                                        </td>
                                    </tr>
                                </table>
